...
export const categories: readonly Category[] = [
  ...
  { id: 'ai-photoshoot', name: 'AI photoshoot', icon: 'ai-photoshoot', placeholder: 'Describe your AI photoshoot vision...', buttonText: 'AI photoshoot', statusBadge: { text: 'New!', color: 'gradient' } },
  ...
  { id: 'product-mockups', name: 'Product mockups', icon: 'product-mockups', placeholder: 'Describe your product mockup needs...', buttonText: 'product mockups', statusBadge: { text: 'New!', color: 'gradient' } },
